...
ctx->_glVertexP2ui = (PFNGLVERTEXP2UIPROC)get_proc(libgl, "glVertexP2ui");
ctx->_glVertexP2uiv = (PFNGLVERTEXP2UIVPROC)get_proc(libgl, "glVertexP2uiv");
ctx->_glVertexP3ui = (PFNGLVERTEXP3UIPROC)get_proc(libgl, "glVertexP3ui");
ctx->_glVertexP3uiv = (PFNGLVERTEXP3UIVPROC)get_proc(libgl, "glVertexP3uiv");
ctx->_glVertexP4ui = (PFNGLVERTEXP4UIPROC)get_proc(libgl, "glVertexP4ui");
ctx->_glVertexP4uiv = (PFNGLVERTEXP4UIVPROC)get_proc(libgl, "glVertexP4uiv");
ctx->_glTexCoordP1ui = (PFNGLTEXCOORDP1UIPROC)get_proc(libgl, "glTexCoordP1ui");
ctx->_glTexCoordP1uiv = (PFNGLTEXCOORDP1UIVPROC)get_proc(libgl, "glTexCoordP1uiv");
ctx->_glTexCoordP2ui = (PFNGLTEXCOORDP2UIPROC)get_proc(libgl, "glTexCoordP2ui");
ctx->_glTexCoordP2uiv = (PFNGLTEXCOORDP2UIVPROC)get_proc(libgl, "glTexCoordP2uiv");
ctx->_glTexCoordP3ui = (PFNGLTEXCOORDP3UIPROC)get_proc(libgl, "glTexCoordP3ui");
ctx->_glTexCoordP3uiv = (PFNGLTEXCOORDP3UIVPROC)get_proc(libgl, "glTexCoordP3uiv");
ctx->_glTexCoordP4ui = (PFNGLTEXCOORDP4UIPROC)get_proc(libgl, "glTexCoordP4ui");
ctx->_glTexCoordP4uiv = (PFNGLTEXCOORDP4UIVPROC)get_proc(libgl, "glTexCoordP4uiv");
ctx->_glMultiTexCoordP1ui = (PFNGLMULTITEXCOORDP1UIPROC)get_proc(libgl, "glMultiTexCoordP1ui");
ctx->_glMultiTexCoordP1uiv = (PFNGLMULTITEXCOORDP1UIVPROC)get_proc(libgl, "glMultiTexCoordP1uiv");
ctx->_glMultiTexCoordP2ui = (PFNGLMULTITEXCOORDP2UIPROC)get_proc(libgl, "glMultiTexCoordP2ui");
ctx->_glMultiTexCoordP2uiv = (PFNGLMULTITEXCOORDP2UIVPROC)get_proc(libgl, "glMultiTexCoordP2uiv");
ctx->_glMultiTexCoordP3ui = (PFNGLMULTITEXCOORDP3UIPROC)get_proc(libgl, "glMultiTexCoordP3ui");
ctx->_glMultiTexCoordP3uiv = (PFNGLMULTITEXCOORDP3UIVPROC)get_proc(libgl, "glMultiTexCoordP3uiv");
ctx->_glMultiTexCoordP4ui = (PFNGLMULTITEXCOORDP4UIPROC)get_proc(libgl, "glMultiTexCoordP4ui");
ctx->_glMultiTexCoordP4uiv = (PFNGLMULTITEXCOORDP4UIVPROC)get_proc(libgl, "glMultiTexCoordP4uiv");
ctx->_glNormalP3ui = (PFNGLNORMALP3UIPROC)get_proc(libgl, "glNormalP3ui");
ctx->_glNormalP3uiv = (PFNGLNORMALP3UIVPROC)get_proc(libgl, "glNormalP3uiv");
ctx->_glColorP3ui = (PFNGLCOLORP3UIPROC)get_proc(libgl, "glColorP3ui");
ctx->_glColorP3uiv = (PFNGLCOLORP3UIVPROC)get_proc(libgl, "glColorP3uiv");
ctx->_glColorP4ui = (PFNGLCOLORP4UIPROC)get_proc(libgl, "glColorP4ui");
ctx->_glColorP4uiv = (PFNGLCOLORP4UIVPROC)get_proc(libgl, "glColorP4uiv");
ctx->_glSecondaryColorP3ui = (PFNGLSECONDARYCOLORP3UIPROC)get_proc(libgl, "glSecondaryColorP3ui");
ctx->_glSecondaryColorP3uiv = (PFNGLSECONDARYCOLORP3UIVPROC)get_proc(libgl, "glSecondaryColorP3uiv");
